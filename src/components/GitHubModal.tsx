              ...
              <form onSubmit={handleConnect} className="space-y-4">
                ...
                <div className="flex items-center justify-end gap-3 pt-2">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs sm:text-sm font-bold text-white bg-slate-900 hover:bg-slate-800 dark:bg-emerald-600 dark:hover:bg-emerald-700 active:scale-95 transition-all shadow-md disabled:opacity-50 cursor-pointer"
                  >
                    {isConnecting ? (
                      <>
                      ...
                      <>
                        ...
                        <span>الاتصال بحساب GitHub</span>
                      </>
                    )}
                  </button>
                </div>
